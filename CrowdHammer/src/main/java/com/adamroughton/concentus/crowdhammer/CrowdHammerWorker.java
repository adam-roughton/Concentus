...
import com.adamroughton.concentus.crowdhammer.worker.WorkerServiceConfiguration;
import com.esotericsoftware.minlog.Log;

public final class CrowdHammerWorker implements ConcentusProcess<WorkerClusterHandle, CrowdHammerConfiguration>, 
	...
	public static void main(String[] args) {
		...
		commandLineConfigurations.put(
				new ConcentusProcessConfiguration<>(worker, CrowdHammerConfiguration.class, new DefaultProcessCallback()), 
				new ConfigurationOperation() {
					...
					public void doOperation(CommandLineConfiguration<?> config,
						...
						ConcentusProcessConfiguration<WorkerClusterHandle, CrowdHammerConfiguration> baseConfig
							= (ConcentusProcessConfiguration<WorkerClusterHandle, CrowdHammerConfiguration>) config;
	...
	private static CrowdHammerService createCrowdHammerService(final String serviceClassName) {
		try {
			...
			if (ConsentusService.class.isAssignableFrom(clazz)) {
				...
				return new ConcentusServiceAdapter(consentusServiceClass);
